  ...
  return (
    <>
      <PageMasthead
        ...
        title="Small place, small club, on purpose."
      ...
      <div className="wrap band grid gap-12 md:grid-cols-12">
        ...
        <aside className="md:col-span-4 md:col-start-9">
          <Photo image={club.heroImage} ratio="landscape" alt sizes="(min-width: 768px) 33vw, 100vw" />
          <dl className="mt-10">
            {[
      ...
      <section className="bg-panel band">
        <div className="wrap grid gap-10 md:grid-cols-2">
          <div className="organic bg-page p-8">
          ...
          <div className="organic-alt bg-page p-8">
            <h2 className="text-xs font-semibold tracking-[0.16em] text-accent uppercase">Vision</h2>
            <p className="mt-4 font-heading text-2xl leading-snug font-semibold text-ink">
              {club.about.vision}
            </p>
          </div>
